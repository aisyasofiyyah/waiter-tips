...
st.subheader("Waiter Tips App is where we analyse the tips given to a waiter for serving the food in a restaurant depends on what kind of factors and predict the tips.")

tips = pd.read_csv('https://raw.githubusercontent.com/aisyasofiyyah/waiter-tips/main/tips.csv')

st.sidebar.markdown("Reference: \nZahra Amini, [Kaggle](https://www.kaggle.com/datasets/aminizahra/tips-dataset)")
